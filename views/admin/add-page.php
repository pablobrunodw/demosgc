...
<div class="col-xs-12 admin-header">
	<h3>
		<i class="add icon"></i> Agregar Página
	</h3>
</div>
...
<form enctype="multipart/form-data" id="page_form" class="ui form col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2 news-form" method="POST">
	...
	<div class="col-xs-12 col-sm-6">
		...
		<div class="ui left icon input">
			<input type="text" name="txtTitle" class="txtTitle" placeholder="Título" id="txtTitle">
...
<script>
		...
		<div class="ui left icon field">
			<select class="txtTypeMenu" name="txtTypeMenu" id="txtTypeMenu">
				...
				<?php foreach ($menu_types as $menu_type): ?>
					<option value="<?php echo $menu_type['mtype_id']; ?>"><?php echo $menu_type['type']; ?></option>
				<?php endforeach; ?>
			</select>
		</div>
	</div>
		...
		<div class="ui left icon field">
			<select class="txtParent" name="txtParent" id="txtParent">
				...
				<?php foreach ($parents_menus as $parents_menu): ?>
					<option value="<?php echo $parents_menu['menu_id']; ?>"><?php echo $parents_menu['title']; ?></option>
				<?php endforeach; ?>
			</select>
		</div>
	</div>
			...
			<div class="ui left icon field">
				<select class="txtArticles" name="txtArticles" id="txtArticles">
					...
					<?php foreach ($articles as $article): ?>
						<option value="<?php echo $article['art_id']; ?>"><?php echo $article['title']; ?></option>
					<?php endforeach; ?>
				</select>
			</div>
	...
	<div class="ui buttons pull-right">
	  <button class="ui positive button btnSavePage">Guardar</button>
